...
(function (Mozilla) {
    ...
    if ((window.site.getPlatform() === 'windows') && (parseFloat(window.site.getPlatformVersion()) >= 6.2)) {
        document.documentElement.className += ' win8up';
    }
    ...
    var beginAnimation = function (syncConfig) {
        ...
        var onVerificationComplete = function () {
            ...
            document.getElementById('white-overlay').addEventListener('transitionend', function(event) {
